      ...
      <section className="container mx-auto py-16 px-6">
        ...
        <div className="grid lg:grid-cols-3 gap-8 items-start">
          ...
          <div className="lg:col-span-2 bg-white rounded-2xl p-8 shadow-lg border border-green-100 hover:shadow-xl transition-all duration-300">
            ...
            <p className="text-gray-600 leading-relaxed text-lg">
              ...
              ฉันเอง นายกานต์ สุดดี เรียกสั้น ๆ ว่า กานต์ ซึ่งเป็นนักศึกษาแขนง Network ในวิชา Internet of Things
              โค้ดชุดนี้เป็นโค้ดสำหรับส่งงาน Assignment Hono Week 2
            </p>
          </div>
        ...
        <div className="mt-12 bg-gradient-to-r from-green-50 to-emerald-50 rounded-2xl p-8 border border-green-200">
          ...
          <p className="text-gray-600 leading-relaxed">
            ปัจจุบันคาเฟ่ และห้องสมุดของเรา อยู่ในช่วงการดูแลของ นายกานต์ สุดดี รหัสประจำตัวนักศึกษา 66070014 
            {/* TODO: ชื่อของตนเอง, รหัสประจำตัวนักศึกษา และแนะนำคาเฟ่นี้ต่ออีกสักหน่อย + ใส่รูปของตนเอง (ไม่จำเป็นหากไม่สะดวกใจใส่รูป) */}
            ซึ่งมีบริการสำหรับให้เข้าไปเยี่ยมชมหนังสือได้ ผ่านแถบเมนูด้านบน โดยการกดคลิกไปที่คำว่าหนังสือ ซึ่งในหน้านั้น คุณจะพบกับหนังสือประมาณ 10 เล่ม ซึ่งสามารถกดเข้าไปดูรายละเอียด และแก้ไขรายละเอียดได้
            หรือถ้าอยากเพิ่มหนังสือของคุณเอง ก็สามารถกดปุ่มเพิ่มหนังสือ ในมุมขวา เพื่อเข้าไปสร้างหนังสืออันใหม่ได้ นอกจากนี้ เว็บไซต์ยังมีหน้าสำหรับให้ผู้ที่เข้ามาเยี่ยมชมได้สั่งเครื่องดื่มอีกด้วย
            โดยการกดคลิกไปที่คำว่าเครื่องดื่ม ในแถบด้านบน จากนั้นคุณจะพบกับเมนูเครื่องดื่มประมาณ 10 เมนู ให้คุณสามารถกดเพิ่มลงตะกร้า จากนั้นให้ใส่ชื่อของคุณ พร้อมกับหมายเหตุ (ถ้าต้องการ) จากนั้นก็กดยืนยันการสั่งซื้อ
            แล้วลองกดเข้าปุ่มสำหรับ staff เพื่อเข้าไปดูรายการ order ที่คนอื่น ๆ สั่งได้
          </p>
        </div>
